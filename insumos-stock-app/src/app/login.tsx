...
export default function LoginScreen() {
  ...
  return (
    <KeyboardAwareScrollView className='w-full max-w-4xl bg-neutral-100 dark:bg-neutral-900 pt-12' enableOnAndroid extraScrollHeight={58} keyboardShouldPersistTaps='handled' contentContainerStyle={{paddingHorizontal: 32, paddingTop: 50, paddingBottom: 28}}>
